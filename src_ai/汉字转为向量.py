...
def cbow(context_words, target_word, word_index, learning_rate, W1, W2, epochs):
    for _ in range(epochs):
        ...
        # STEP 5
        # Calculate error
        E = np.subtract(y_pred, np.array(
            [1 if word_index[word] == word_index[target_word] else 0 for word in word_index.keys()]))
...
learning_rate = 0.01
epochs = 1000
W1, W2 = cbow(context_words, target_word, word_index,
              learning_rate, W1, W2, epochs)
print(W1, W2)
